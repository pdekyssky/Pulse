/**
 * Services page header with add-service action.
 */
...
export default function ServicesHeader({ onCreateClick }: ServicesHeaderProps) {
  return (
    <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      <div>
        <h2 className="text-2xl font-semibold tracking-tight text-gray-900">Services</h2>
        <p className="mt-1 max-w-2xl text-sm text-gray-500">
          View and manage the services monitored across your infrastructure.
        </p>
      </div>
